...
public class SlidingDrawer extends ViewGroup {
	...
	private void prepareContent() {
		...
		if (!isHardwareAccelerated(content))
	...
	@SuppressLint("NewApi")
	private static boolean isHardwareAccelerated(View v) {
	...
	public class DrawerContentAnimator implements AnimationListener,
		...
		public DrawerContentAnimator(Animation fadeIn, Animation fadeOut,
				View content) {
		...
		public void onAnimationEnd(Animation animation) {
			if (animation.equals(mFadeOut))
				content.setVisibility(View.GONE);
		}

		@Override
		public void onAnimationStart(Animation animation) {
			if (animation.equals(mFadeIn))
				content.setVisibility(View.VISIBLE);
		}

		@Override
		public void onScrollStarted() {
			if (SlidingDrawer.this.isOpened())
				content.startAnimation(mFadeIn);
			else
				content.startAnimation(mFadeOut);
		}
